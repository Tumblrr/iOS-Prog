...
A simple, interactive daily planner built with SwiftUI. This app allows users to view their daily schedule, check off completed tasks, and dynamically add new ones.
